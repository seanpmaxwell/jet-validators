...
export const testObj = <U extends TSchema>(arg: U, onError?: TParseOnError<false>) => 
  _testObj<U, false, false, false>(arg, false, false, false, onError);
export const testOptObj = <U extends TSchema>(arg: U, onError?: TParseOnError<false>) => 
  _testObj<U, true, false, false>(arg, true, false, false, onError);
export const testNulObj = <U extends TSchema>(arg: U, onError?: TParseOnError<false>) => 
  _testObj<U, false, true, false>(arg, false, true, false, onError);
export const testNishObj = <U extends TSchema>(arg: U, onError?: TParseOnError<false>) => 
  _testObj<U, true, true, false>(arg, true, true, false, onError);
export const testObjArr = <U extends TSchema>(arg: U, onError?: TParseOnError<true>) => 
  _testObj<U, false, false, true>(arg, false, false, true, onError);
export const testOptObjArr = <U extends TSchema>(arg: U, onError?: TParseOnError<true>) => 
  _testObj<U, true, false, true>(arg, true, false, true, onError);
export const testNulObjArr = <U extends TSchema>(arg: U, onError?: TParseOnError<true>) => 
  _testObj<U, false, true, true>(arg, false, true, true, onError);
export const testNishObjArr = <U extends TSchema>(arg: U, onError?: TParseOnError<true>) => 
