/**
 * This is the raw TypeScript version of parse object core which does not
 * use a parser function. It should not be included in the build so it will
 * not work with the benchmarks file.
 */
